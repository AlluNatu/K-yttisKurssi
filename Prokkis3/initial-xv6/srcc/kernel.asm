...
80104a60 <syscall>:
[SYS_getreadcount] sys_getreadcount, // Links the getreadcount system call to its handler function
};
...
80104c70 <sys_getreadcount>:
}
80104c70:	a1 58 3c 11 80       	mov    0x80113c58,%eax
80104c75:	c3                   	ret    
...
80104c8e:	e8 8d fc ff ff       	call   80104920 <argint>
...
80104d08:	83 ec 18             	sub    $0x18,%esp
  readCount++; // Increment the count by 1 every time the read system call is used.
80104d0b:	83 05 58 3c 11 80 01 	addl   $0x1,0x80113c58
  if(argint(n, &fd) < 0)
80104d12:	53                   	push   %ebx
80104d13:	6a 00                	push   $0x0
80104d15:	e8 06 fc ff ff       	call   80104920 <argint>
80104d1a:	83 c4 10             	add    $0x10,%esp
80104d1d:	85 c0                	test   %eax,%eax
80104d1f:	78 5f                	js     80104d80 <sys_read+0x80>
  if(fd < 0 || fd >= NOFILE || (f=myproc()->ofile[fd]) == 0)
80104d21:	83 7d f4 0f          	cmpl   $0xf,-0xc(%ebp)
80104d25:	77 59                	ja     80104d80 <sys_read+0x80>
80104d27:	e8 44 ec ff ff       	call   80103970 <myproc>
80104d2c:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104d2f:	8b 74 90 28          	mov    0x28(%eax,%edx,4),%esi
80104d33:	85 f6                	test   %esi,%esi
80104d35:	74 49                	je     80104d80 <sys_read+0x80>
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argptr(1, &p, n) < 0)
80104d37:	83 ec 08             	sub    $0x8,%esp
80104d3a:	8d 45 f0             	lea    -0x10(%ebp),%eax
80104d3d:	50                   	push   %eax
80104d3e:	6a 02                	push   $0x2
80104d40:	e8 db fb ff ff       	call   80104920 <argint>
80104d45:	83 c4 10             	add    $0x10,%esp
80104d48:	85 c0                	test   %eax,%eax
80104d4a:	78 34                	js     80104d80 <sys_read+0x80>
80104d4c:	83 ec 04             	sub    $0x4,%esp
80104d4f:	ff 75 f0             	push   -0x10(%ebp)
80104d52:	53                   	push   %ebx
80104d53:	6a 01                	push   $0x1
80104d55:	e8 16 fc ff ff       	call   80104970 <argptr>
80104d5a:	83 c4 10             	add    $0x10,%esp
80104d5d:	85 c0                	test   %eax,%eax
80104d5f:	78 1f                	js     80104d80 <sys_read+0x80>
  return fileread(f, p, n);
80104d61:	83 ec 04             	sub    $0x4,%esp
80104d64:	ff 75 f0             	push   -0x10(%ebp)
80104d67:	ff 75 f4             	push   -0xc(%ebp)
80104d6a:	56                   	push   %esi
80104d6b:	e8 b0 c2 ff ff       	call   80101020 <fileread>
...
80104d85:	eb ec                	jmp    80104d73 <sys_read+0x73>
